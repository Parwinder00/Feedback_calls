...
public class Insert extends AppCompatActivity{
    ...
    private class MyTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params){
            ...
            String InfoReceivedphone = myNewIntent.getStringExtra("phone");
            String InfoReceivedaddress = myNewIntent.getStringExtra("address");
            String cid = myNewIntent.getStringExtra("cid");



            try{

                url = new URL("http://192.168.5.15:8080/Teacher_evaluation/cegepgim/mobile/insertfeedback&" +InfoReceivedId +"&" +InfoReceivedfname +"&" +InfoReceivedlname +"&" +InfoReceivedphone +"&" + InfoReceivedaddress +"&"+cid);
